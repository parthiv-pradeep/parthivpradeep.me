      ...
      <section id="about" className="container py-24 lg:py-40">
        <div className="flex flex-col space-y-8">
          ...
          <div className="flex gap-4">
            <Link href="mailto:elhussary@protonmail.com" target="_blank">
            ...
            <div className="space-x-2">
              {/* Github */}
              <Link href="https://github.com/elhussary" target="_blank">
                <Button
                  variant="outline"
                  size="icon"
              ...
              {/* X (Twitter) */}
              <Link href="https://x.com/elhussaryy" target="_blank">
                <Button
                  variant="outline"
                  size="icon"
